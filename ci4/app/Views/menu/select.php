        ...
        <table class="table">
            ...
            <?php foreach ($menu as $key => $value) : ?>
                ...
                <tr>
                    ...
                    <td><a href="<?= base_url() ?>/admin/menu/delete/<?php echo $value['idmenu']; ?>"><img src="<?= base_url('icon/trash.svg') ?>" alt=""></a></td>
                    <td><a href="<?= base_url() ?>/admin/menu/find/<?php echo $value['idmenu']; ?>"><img src="<?= base_url('icon/pencil.svg') ?>" alt=""></a></td>
                </tr>
            <?php endforeach; ?>
